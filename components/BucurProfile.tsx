...
export function BucurProfile({locale, clinic}: {locale: string; clinic: Clinic}) {
  ...
  return <>
    ...
    <section className="section"><div className="container bucur-introduction"><SectionHeading eyebrow={c.label} title={c.heading} /><p className="lead">{c.about}</p></div></section>
    ...
    <section className="section section-soft"><div className="container bucur-network"><SectionHeading eyebrow={c.networkLabel} title={c.networkTitle} /><p>{c.network}</p></div></section>
